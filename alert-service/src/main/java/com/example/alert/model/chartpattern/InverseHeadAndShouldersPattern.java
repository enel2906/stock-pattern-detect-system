...
/**
 * Model đại diện cho Inverse Head and Shoulders pattern detection result
 */
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class InverseHeadAndShouldersPattern {
    ...
    private String patternType; // "inverse_head_and_shoulders"
}
